...
libertadores:[C("Flamengo",82,1109),C("Palmeiras",81,1113),C("River Plate",80,1076),C("Boca Juniors",79,1075),C("Fluminense",78,1110),C("São Paulo",78,1116),C("Atlético Mineiro",77,1108),C("Grêmio",76,1111),C("Internacional",76,1112),C("Cruzeiro",75,1117),C("Corinthians",75,1107),C("Santos",74,1115),C("Athletico Paranaense",73,1120),C("Botafogo",76,1106),C("Fortaleza",74,1121),C("Bahia",73,1119),C("Vasco da Gama",72,1118),C("Peñarol",75,1356),C("Nacional",74,1355),C("Colo Colo",73,1348),C("Universidad de Chile",71,1351),C("Universidad Católica",70,1350),C("Barcelona SC",70,1357),C("LDU Quito",69,1358),C("Independiente del Valle",68,1360),C("Cerro Porteño",72,1359),C("Olimpia",71,1361),C("Libertad",70,1362),C("Estudiantes LP",72,1077),C("Racing",71,1078),C("Independiente",70,1079),C("San Lorenzo",69,1080),C("Talleres",68,1081),C("Lanús",67,1082),C("Defensa y Justicia",66,1083),C("Rosario Central",67,1084),C("Newell's",66,1085),C("Huracán",65,1086),C("Belgrano",64,1087),C("Gimnasia LP",64,1088),C("Palestino",66,1349),C("Unión Española",65,1352),C("Everton VM",63,1353),C("Santiago Wanderers",62,1354),C("Audax Italiano",61,1363),C("Deportes Iquique",60,1364),C("Cobresal",59,1365),C("Coritiba",70,1122),C("Ceará",68,1123)],
sudamericana:[C("Independiente",70,1079),C("Racing",71,1078),C("São Paulo",78,1116),C("Santos",74,1115),C("LDU Quito",69,1358),C("Barcelona SC",70,1357),C("Athletico Paranaense",73,1120),C("Coritiba",70,1122),C("Defensa y Justicia",66,1083),C("Lanús",67,1082),C("Fortaleza",74,1121),C("Ceará",68,1123),C("Vasco da Gama",72,1118),C("Bahia",73,1119),C("Cruzeiro",75,1117),C("Grêmio",76,1111),C("Internacional",76,1112),C("Corinthians",75,1107),C("Botafogo",76,1106),C("Peñarol",75,1356),C("Nacional",74,1355),C("Cerro Porteño",72,1359),C("Olimpia",71,1361),C("Libertad",70,1362),C("Estudiantes LP",72,1077),C("San Lorenzo",69,1080),C("Talleres",68,1081),C("Huracán",65,1086),C("Belgrano",64,1087),C("Rosario Central",67,1084),C("Newell's",66,1085),C("Colo Colo",73,1348),C("Universidad de Chile",71,1351),C("Universidad Católica",70,1350),C("Palestino",66,1349),C("Unión Española",65,1352),C("Audax Italiano",61,1363),C("Independiente del Valle",68,1360)],
liga_arg:[C("River Plate",80,1076),C("Boca Juniors",79,1075),C("Independiente",70,1079),C("Racing",71,1078),C("San Lorenzo",69,1080),C("Huracán",65,1086),C("Rosario Central",67,1084),C("Newell's",66,1085),C("Estudiantes LP",72,1077),C("Gimnasia LP",64,1088),C("Talleres",68,1081),C("Belgrano",64,1087),C("Lanús",67,1082),C("Defensa y Justicia",66,1083),C("Vélez Sarsfield",68,1089),C("Argentinos Jrs",65,1090),C("Banfield",64,1091),C("Godoy Cruz",63,1092),C("Independiente Rivadavia",62,1093),C("Platense",61,1094),C("Tigre",62,1095),C("Unión",63,1096),C("Central Córdoba",60,1097),C("Instituto",61,1098),C("Barracas Central",59,1099),C("Sarmiento",58,1100),C("Atlético Tucumán",62,1101),C("Deportivo Riestra",57,1102),C("Los Andes",56,1103),C("Chacarita",58,1104)],
liga_chil:[C("Colo Colo",73,1348),C("Universidad de Chile",71,1351),C("Universidad Católica",70,1350),C("Palestino",66,1349),C("Unión Española",65,1352),C("Everton VM",63,1353),C("Santiago Wanderers",62,1354),C("Audax Italiano",61,1363),C("Deportes Iquique",60,1364),C("Cobresal",59,1365),C("O'Higgins",62,1366),C("Huachipato",61,1367),C("Coquimbo Unido",60,1368),C("Ñublense",59,1369),C("Unión La Calera",58,1370),C("Magallanes",57,1371),C("Deportes Copiapó",56,1372),C("Puerto Montt",55,1373),C("Rangers",54,1374),C("Curicó Unido",53,1375)]};
const LEAGUES={
...
libertadores:{name:'Copa Libertadores',icon:'🏆',color:'#003da5',espn:'conmebol.libertadores',teams:'libertadores',ko:true,logo:13,sub:'Torneo de clubes más importante de Sudamérica.'},
sudamericana:{name:'Copa Sudamericana',icon:'🥈',color:'#ff6600',espn:'conmebol.sudamericana',teams:'sudamericana',ko:true,logo:14,sub:'Segunda competición de clubes de Sudamérica.'},
liga_arg:{name:'Liga Argentina',icon:'🇦🇷',color:'#75aadb',espn:'arg.1',teams:'liga_arg',logo:1,sub:'Primera División de Argentina 2026.'},
liga_chil:{name:'Campeonato Chileno',icon:'🇨🇱',color:'#d92323',espn:'chi.1',teams:'liga_chil',logo:7,sub:'Primera División de Chile 2026.'}};
...
sudamericana:[{a:"Independiente",b:"Racing"},{a:"São Paulo",b:"Santos"},{a:"LDU Quito",b:"Barcelona SC"},{a:"Athletico Paranaense",b:"Coritiba"},{a:"Defensa y Justicia",b:"Lanús"},{a:"Fortaleza",b:"Ceará"}],
...
liga_chil:[{a:"Colo Colo",b:"Universidad de Chile"},{a:"Universidad Católica",b:"Universidad de Chile"},{a:"Colo Colo",b:"Universidad Católica"},{a:"Palestino",b:"Unión Española"},{a:"Everton VM",b:"Santiago Wanderers"},{a:"Audax Italiano",b:"Unión Española"}]};
...
function findAnyTeam(name){const q=norm(name);if(!q)return null;const all=poolAll();return all.find(t=>norm(t.es)===q)||all.find(t=>q.length>=3&&norm(t.es).includes(q))||null;}
...
async function fetchESPNday(leagueId,ymd){
  try{let url='https://site.api.espn.com/apis/site/v2/sports/soccer/'+LEAGUES[leagueId].espn+'/scoreboard';
    if(ymd)url+='?dates='+ymd;
    const r=await fetch(url);if(!r.ok)return[];const d=await r.json();return (d&&d.events)||[];}catch(e){return[];}
}
function espnParse(ev){
  ...
  let yellow=0,yA=0,yB=0;const scorers=[];
  (comp.details||[]).forEach(d=>{
    ...
    if(d.scoringPlay&&!d.shootout){const ath=d.athletesInvolved&&d.athletesInvolved[0];
      scorers.push({min:(d.clock&&d.clock.displayValue)||'',name:ath?ath.displayName:''});}});
  function statOf(names){const cats=comp.statistics||[];
  ...
  const poss=statOf(['possessionPct','ballPossession']);
  const sh=statOf(['totalShots','shots']);
  const co=statOf(['wonCorners','corners']);
  return {id:ev.id,date:ev.date,
    ...
    stats:{homePoss:poss.home,awayPoss:poss.away,homeShots:sh.home,awayShots:sh.away,homeCorners:co.home,awayCorners:co.away,yellow,yellowA:yA,yellowB:yB,scorers}};
}
  ...
  try{
    ...
    try{const idB=espnTeamId(tb.es);
      if(idB){const r2=await fetch('https://site.api.espn.com/apis/site/v2/sports/soccer/'+LEAGUES[CURRENT_LEAGUE].espn+'/teams/'+idB+'/schedule');
        if(r2.ok){const d2=await r2.json();rb=recentAvg(d2.events||[],String(idB));}}}catch(e){}
    let src='rating base';
...
function renderHistory(){
  ...
  list.innerHTML=shown.map(it=>{
    ...
    if(!done){
      ...
      detail='<div class="hist-meta">'+(it.ctx||'')+' · pred: '+predTxt+'</div><div class="badges">'+bdg(j.hitRes,'Resultado')+bdg(j.hitScore,'Marcador')+bdg(j.hitOU,'O/U 2.5')+bdg(j.hitBtts,'BTTS')+'</div>'+extra;
    }
...
/* ═══════════ EN VIVO + TICKER ═══════════ */
let LV_DATE=new Date(),liveFilter='all',_liveFlat=[],_tickerFlat=[],_lvLoading=false,_tkrLoading=false,_tickerAt=0;
...
async function renderLive(force){
  ...
  try{
    ...
    _liveFlat=flat;checkGoalNotifs(flat);
    ...
    body.innerHTML=shown.map(g=>{
      ...
      return '<div><div class="lv2-grp-h">'+
        ...
        g.evs.map(m=>{
          ...
          return '<div class="lv2-match'+(m.state==='in'?' live':'')+'" onclick="openLiveMatchObj(_liveFlat['+m.idx+'])">'+
...
function openLiveMatchObj(m){
  if(!m)return;
  const ta=findAnyTeam(m.A),tb=findAnyTeam(m.B);
...
function runSim(scroll){
  ...
  el('mSub').textContent='λ '+lamH.toFixed(2)+' · '+lamA.toFixed(2)+' · ρ '+rho.toFixed(3)+(LEARN.apply&&LEARN.ready?' · calibración ×'+LEARN.goalAdj.toFixed(3):'');
...
function ratingOf(name){const t=findAnyTeam(name);return t?t.s:(name?62:null);}
...
function renderBracket(){
  ...
  const isKO=CURRENT_LEAGUE==='worldcup'||CURRENT_LEAGUE==='champions';
  ...
  if(!isKO){host.innerHTML='<div class="empty" style="min-width:320px">Cuadro disponible solo para Mundial y Champions. Para ligas, consultá la Tabla.</div>';el('bkEditor').innerHTML='';return;}
...
function renderStatsView(){
  ...
  let tableHtml;
  if(noData){tableHtml='<div class="empty">Sin partidos de '+LEAGUES[CURRENT_LEAGUE].name+' en tu historial.</div>';}
  else{
  ...
  elm.innerHTML='<div class="panel"><div class="panel-h"><h3>Tabla · '+LEAGUES[CURRENT_LEAGUE].name+'</h3><span class="rule"></span></div>'+tableHtml+'</div>'+
    '<div><div class="panel"><div class="panel-h"><h3>Goleadores</h3><span class="rule"></span></div>'+scHtml+'</div>'+
    '<div class="panel" style="margin-top:16px"><div class="panel-h"><h3>Criterio</h3><span class="rule"></span></div><p style="font-size:12px;color:var(--mut);line-height:1.7">Cada predicción guardada suma un partido: con resultado real se usa ese; si no, el escenario más probable del modelo.</p></div></div>';
}
